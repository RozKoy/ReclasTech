...
const CardService = (props) => {
  return (
    <div className="card hover:scale-105 transa flex-grow-0 flex-shrink-0 bg-white rounded-[20px] shadow-md py-8 px-7 w-[365px] hover:bg-primary2 hover:text-white transition-all duration-300">
